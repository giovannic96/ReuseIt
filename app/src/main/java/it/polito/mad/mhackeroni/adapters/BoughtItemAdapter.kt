...
class BoughtItemAdapter(private var items: MutableList<Item>, private val listener: MyAdapterListener):
    RecyclerView.Adapter<BoughtItemAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return if (viewType == VIEW_TYPE_ITEM) {
            v = LayoutInflater.from(parent.context)
                .inflate(R.layout.bought_item, parent, false) //get layout inflater and inflate item layout
        ...
        override fun bind(item: Item) {
            ...
            if(item.image.isNullOrEmpty()) {
                ...
                try {
                    ...
                    val logger: Logger = Logger.getLogger(BoughtItemAdapter::class.java.name)
